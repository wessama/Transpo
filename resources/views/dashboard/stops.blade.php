            ...
            <div class="au-card-title" style="background-image:url('');">
                ...
                <div class="filters m-b-45">
                    <div class="rs-select2--light rs-select2--md">
                        ...
                        <option value="{{ route('stops', ['id' => $round->id] + \Request::all()) }}">{{ $round->round }}</option>
                        @endforeach
                    </select>
                ...
                <div class="rs-select2--light rs-select2--lg">
                        ...
                        <option value="{{ route('stops', ['location' => $location->id] + \Request::all()) }}">{{ $location->address }}</option>
                        @endforeach
                    </select>
                    <div class="dropDownSelect2"></div>
                </div>
                <div class="rs-select2--light rs-select2--md">
                    ...
                    <option value="{{ route('stops', ['day' => $day->id] + \Request::all()) }}">{{ $day->day }}</option>
                    @endforeach
                </select>
                <div class="dropDownSelect2"></div>
            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	{{ \Carbon\Carbon::parse($point->Schedule->first()->time)->format('h:i A') }}
                                	</td>
                                    <td>
                                        {{ \Carbon\Carbon::parse($point->Schedule->first()->time_alt)->format('h:i A') }}
                                    </td>
                            	</tr>
                            	@endforeach
                        </tbody>
